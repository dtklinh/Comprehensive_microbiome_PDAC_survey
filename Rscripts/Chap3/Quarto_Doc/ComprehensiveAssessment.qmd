...
```{r}
df_analysis <- df_all %>%
  mutate(Method2 = if_else(Method=="Fisher", "Nj", 
                           if_else(Method=="origin", "Raw",
                                   if_else(Method=="decontam", "Decontam",
                                           if_else(Method=="restrictive", "Restrictive", Method))))) %>% 
...
```{r}
df_analysis$Method <- factor(df_analysis$Method, levels = c("Nj", "Raw", "Decontam", "Restrictive", "SCRuB"))
