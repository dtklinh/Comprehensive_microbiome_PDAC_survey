...
pairwise_WT_Method <- function(df){
...
#### 3.2.1 Table of overlap-overall ratio
...
```{r}
## Create table #samples x #Methods
# tmp <- pseq_raw %>% ps_filter(AN_NR == "AN1023")
# tmp_rep <- rep_raw %>% ps_filter(AN_NR == "AN1023")
# df <- tibble(AN_NR = meta(pseq_raw)[["AN_NR"]], 
#              Raw_R1 = vector("list", 10),
#              Raw_R2 = vector("list", 10),
#              Restrictive_R1 = vector("list", 10),
#              Restrictive_R2 = vector("list", 10),
#              Decontam_R1 = vector("list", 10),
#              Decontam_R2 = vector("list", 10),
#              SCRuB_R1 = vector("list", 10),
#              SCRuB_R2 = vector("list", 10),
#              Nj_R1 = vector("list", 10),
#              Nj_R2 = vector("list", 10))
# df$raw_R1_taxa[[1]] <- c(taxa_names(tmp))
