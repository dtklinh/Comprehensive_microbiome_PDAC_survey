...
AlphaPlot_Violin_Wilcox("AN_NR", "Methods", "Val_NegLog", metric = "Neg Log b-ray distance", comparisons = list(c("Raw", "Restrictive"), c("Raw", "Decontam"), c("Raw", "SCRuB"), c("Raw", "Nj")), alternative = "greater")
```
