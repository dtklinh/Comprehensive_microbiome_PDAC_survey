...
Investigate microbiome in overlap
...
CompositionalPlot_Viz_v02(PhyloseqObj = ps_NJ_merged, supper_rank = "phylum", smaller_rank = "family", supper_rank_list = c("Bacillota", "Bacteroidota", "Pseudomonadota"), facet = "Replica", each_num = 4, tax_order_by = sum, my_subtitle = "NJ decontamination")
```
...
pseq_rep1 <- pseq_raw %>% 
  prune_taxa(taxa_names(.) %in% taxa_core, .) %>% 
...
CompositionalPlot_Viz_v02(PhyloseqObj = ps_all_merged, supper_rank = "phylum", smaller_rank = "family", supper_rank_list = c("Bacillota", "Bacteroidota", "Pseudomonadota"), facet = "Replica", each_num = 4, tax_order_by = sum, my_subtitle = "All decontamination")
```
...
CompositionalPlot_Viz_v02(PhyloseqObj = ps_all_merged, supper_rank = "class", smaller_rank = "genus", supper_rank_list = c("Clostridia", "Bacilli", "Bacteroidia"), facet = "Replica", each_num = 4, tax_order_by = sum, my_subtitle = "All decontamination")
```
...
supper_rank = "class" ##"phylum"
smaller_rank =  "genus" ##"family"
