...
df_meta <- read_xlsx("./meta/Chap1_NCT_16S_metadata.xlsx", sheet = "Sheet2")
...
table(rownames(df_meta) %in% colnames(df_count)) 
...
## save to RDS
## v0: metadata as in sheet1
## saveRDS(ps, "./data/Chap1/NCT_2026April_v0.rds")

## v1: metadata as in sheet1
saveRDS(ps, "./data/Chap1/NCT_2026April_v1.rds")
