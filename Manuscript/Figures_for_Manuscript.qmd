...
plt_wrench <- pseq %>% 
  ...
  BetaPlot(strata_f = "Control_type", dis_method = "bray", ordination_method = "PCoA", title_method = "NCT samples stratified by control types - Wrench normalization")
plt_rar <- pseq %>% 
  rarefy_even_depth() %>% 
  BetaPlot(strata_f = "Control_type", dis_method = "bray", ordination_method = "PCoA", title_method = "NCT samples stratified by control types - Rarefaction")
